...
const routes: Routes = [
  ...
  {
    path: 'tickets/comprar/:id',
    component: BuyComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Espectador'] },
  },
  {
    path: 'administracion/generos',
    component: GendersComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/generos/insertar',
    component: GenderInsertComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/generos/editar/:id',
    component: GenderUpdateComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/artistas',
    component: ArtistComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/artistas/insertar',
    component: ArtistInsertComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/artistas/editar/:id',
    component: ArtistUpdateComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/solistas',
    component: SoloistComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/solistas/insertar',
    component: SoloistInsertComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/solistas/editar/:id',
    component: SoloistUpdateComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/bandas',
    component: BandComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/bandas/insertar',
    component: BandInsertComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/bandas/editar/:id',
  ...
  {
    path: 'administracion/usuarios/insertar',
  ...
  {
    path: 'administracion/snacks',
    component: SnacksComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/snacks/insertar',
    component: SnacksInsertComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/importarexportar',
    component: ImportexportComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/conciertos',
    component: ConcertComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/conciertos/insertar',
    component: ConcertInsertComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/conciertos/editar/:id',
    component: ConcertUpdateComponent,
    canActivate: [AuthGuard],
    data: { roles: ['Administrador'] },
  },
  {
    path: 'administracion/conciertos/ver/:id',
    component: ConcertViewComponent,
  },
  {
    path: 'administracion/conciertos/verbyartista/:id',
    component: ConcertArtistViewComponent,
  },
  ...
  {
    path: 'protagonistas/solistas/ver/:id',
    component: ProtagonistSoloistComponent,
  },
