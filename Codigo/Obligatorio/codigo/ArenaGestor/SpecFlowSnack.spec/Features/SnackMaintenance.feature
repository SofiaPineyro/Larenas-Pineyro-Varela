...
Scenario: Snack creation with missing data
	Given I am an administrator
	When I add a new snack with empty name, description "Potato chips", and price 0
	Then the response status code should be 400

Scenario: Duplicate snack creation
	Given I am an administrator
	And there is already a snack with name "Chips" in the snack list
	When I add another snack with name "Chips", description "Tortilla chips", and price 189
	Then the response status code should be 400
